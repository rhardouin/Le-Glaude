# Contributing to Le Glaude

Thank you for your interest in Le Glaude! We appreciate your enthusiasm and support.

## Current Status

**Le Glaude is in active development** — we're iterating quickly and making lots of changes under the hood. Because of this pace, we may be slower than usual when reviewing PRs and issues.
...
If you have questions about using Le Glaude, please check the [README](README.md) first. For other inquiries, feel free to open a discussion or issue.

Thank you for helping make Le Glaude better! 🙏
