  ...
  outputs = {
    ...
    in {
      ...
      packages.default = mkApplication {
        venv = pythonSet.mkVirtualEnv "glaude-env" workspace.deps.default;
        package = pythonSet.le-glaude;
      };

      apps = {
        default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/glaude";
        };
      };
        ...
        default = let
          ...
          editablePythonSet = pythonSet.overrideScope (
            lib.composeManyExtensions [
              ...
              (final: prev: {
                glaude = prev.glaude.overrideAttrs (old: {
          ...
          virtualenv = editablePythonSet.mkVirtualEnv "glaude-dev-env" workspace.deps.all;
        in
          pkgs.mkShell {
            packages = [
              virtualenv
